...
const FootwearCategoryRow = ({ onCategoryClick }) => {
  const categories = [
    { key: 'sandals', name: 'Sandals', image: images.footwears.sandals },
    { key: 'boots', name: 'Boots', image: images.footwears.boots },
    { key: 'flats', name: 'Flats', image: images.footwears.flats },
    { key: 'sneakers', name: 'Sneakers', image: images.footwears.sneakes }
  ];
...
export default FootwearCategoryRow;