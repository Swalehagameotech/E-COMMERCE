              ...
              <div className="p-1 sm:p-1.5 md:p-2 lg:p-3 xl:p-4 flex flex-col flex-grow">
                ...
                <div className="mt-auto">
                  ...
                  <button
                    ...
                    className="w-full bg-[#A87676] hover:bg-[#CA8787] text-white font-medium py-0.5 sm:py-1 md:py-1.5 lg:py-2 px-1 sm:px-2 md:px-3 lg:px-4 rounded sm:rounded-md md:rounded-lg transition-colors duration-200 flex items-center justify-center gap-0.5 sm:gap-1 md:gap-2 text-[10px] sm:text-xs md:text-sm lg:text-base"
                  >
