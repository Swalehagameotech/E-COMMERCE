...
/>
      ...
      <div className="max-w-xs sm:max-w-sm lg:max-w-md w-full space-y-6">
        {/* Card Container */}
        <div className="bg-white/70 backdrop-blur-md rounded-2xl shadow-2xl p-4 sm:p-5 lg:p-6 border border-white/20">
          {/* Header */}
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-2 px-4 border-2 border-gray-300 rounded-lg text-sm text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-sm hover:shadow-md"
          >
            {googleLoading ? (
              <svg
